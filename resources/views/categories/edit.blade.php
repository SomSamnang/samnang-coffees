...
@section('title', 'Edit Category - Samnang Coffee')
                ...
                <div class="form-group">
                 ...
                 <div>
                    ...
                    <select 
                        ...
                        name="status"
                    >
                        <option value="active" @if(old('status', $category->is_active ? 'active' : 'inactive') == 'active') selected @endif>Active</option>
                        <option value="inactive" @if(old('status', $category->is_active ? 'active' : 'inactive') == 'inactive') selected @endif>Inactive</option>
                    </select>
